...
class ViewServiceProvider extends ServiceProvider
{
    ...
    public function boot(): void
    {
        ...
        View::composer(['components.nav', 'components.footer', 'layouts.frontend', 'layouts.login','layouts.app','pages.frontend.contact.index','pages.frontend.login.index'], function ($view) use ($setting) {
