...
<script src="{{ url('public/assets/frontend/js/ajax-form.js') }}"></script>
...
<script src="{{ url('public/assets/frontend/js/audioplayer.js') }}"></script>
<script src="{{ url('public/assets/frontend/js/scrollIt.js') }}"></script>
...
<script src="{{ url('public/assets/frontend/js/nice-select.min.js') }}"></script>
...
<script src="{{ url('public/assets/frontend/js/gijgo.min.js') }}"></script>
